...
const SwapComponent = () => {
  ...
  return (
    <div className='bg-zinc-900 w-[35%] p-4 px-6 rounded-xl blue-glassmorphism'>
      <div className='flex items-center justify-between py-4 px-1'>
        <p>Swap</p>
        
      </div>
      <div className='relative white-glassmorphism  p-4 py-6 rounded-xl mb-2 border-[1px] border-transparent hover:border-zinc-600'>
        {srcTokenComp}

        <ArrowSmDownIcon
          className='absolute white-glassmorphism left-1/2 -translate-x-1/2 -bottom-6 h-10 p-1 bg-[#212429] border-4 border-zinc-900 text-zinc-300 rounded-xl cursor-pointer hover:scale-110'
          onClick={handleReverseExchange}
        />
      </div>

      <div className=' white-glassmorphism p-4 py-6 rounded-xl mt-2 border-[2px] border-transparent hover:border-zinc-600'>
        {destTokenComp}
      </div>
